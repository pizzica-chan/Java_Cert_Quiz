...
/**
 * Oracle Certified Java Programmer, Silver SE 11（1Z0-815-JPN）対策問題。
 *
 * - 本試験の問題そのものではなく、同じ出題範囲・同じ問い方で作成した独自問題
 * - コードを伴う問題は `expected` を持ち、`npm run verify:java` が
 *   実際の JDK 11 でコンパイル・実行して正解を裏取りする
 */
export const questions: SilverQuestion[] = [
  // ============================================================ 基本 (basics)
  {
    id: 1,
    topic: "basics",
